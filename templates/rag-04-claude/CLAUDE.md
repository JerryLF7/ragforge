# RAG Server - Claude (Anthropic)

## Overview
RAG (Retrieval-Augmented Generation) server built using Anthropic Claude API + Voyage AI embeddings + ChromaDB + FastAPI. No LangChain/LlamaIndex — full control over every component.

## Tech Stack
- **API**: FastAPI (port 8000)
- **LLM**: Anthropic Claude (claude-sonnet-4-20250514 default)
- **Embedding**: Voyage AI voyage-3 (1024 dims)
...
- Uses Voyage AI for embeddings (Anthropic's recommended embedding partner)
- Embeddings use `input_type="query"` for queries vs documents for better retrieval
